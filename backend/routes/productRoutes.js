...
import { getAllProducts,featuredProducts,createProduct,deleteProduct,getReccomendedProducts } from "../controllers/product.controller.js";
...
router.route('/reccomendation').get(isProtected,getReccomendedProducts);
